// src/components/Discussion/Discussion.jsx
import React from 'react';
import { Link } from 'react-router-dom';
import './Discussion.css';

const Discussion = ({ discussions, bookId }) => {
    return (
            ...
            {discussions.map((discussion, index) => (
                <div key={index} className="discussion-item">
                    <div className="discussion-header">
                        <img src={discussion.user.avatar} alt={`${discussion.user.name}'s avatar`} className="user-avatar" />
                        <div className="info">
                            <div className="user-info">
                                <strong>{discussion.user.name}</strong>
                                <span>{discussion.user.date}</span>
                                <p className='count'>
                         ...
                         <Link to={`/discussion/${bookId}/${index}`} className="question-link"> {/* Ссылка на DiscussionPage */}
